...
uniform int selectedModelComponent;
uniform uint modelComponentID;
...
void main()
{
	const vec4 fragKad = semiTransparentUniform(getKad() * (selectedModelComponent == modelComponentID ? 1.5f : 1.0f));
